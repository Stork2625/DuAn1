 ...
 * @author GIGABYTE
 */
public class Them_Kieu_Day extends javax.swing.JFrame {
    ...
    public void fill(ArrayList<Kieu_Day_entity> list) {
        mol.setRowCount(0);
        for (Kieu_Day_entity kd : list) {
            Object[] rowData
                    = {
                        kd.getId(),
                        kd.getTenKieuDay()
    ...
    public void ThemCL() {
        String sql = "INSERT INTO [dbo].[KieuDay]\n"
                + "           ([LoaiDay])\n"
                + "     VALUES\n"
                + "           (?)";
    ...
    public void XoaCL() {
        String sql = "DELETE FROM [dbo].[KieuDay]\n"
                + "      WHERE IDKieuDay = ?";
        try (Connection con = DBConnect.getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ID kiểu dây:");

        jLabel3.setText("Kiểu dây:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Them_Kieu_Day.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Them_Kieu_Day().setVisible(true);
            }
        });
    }
