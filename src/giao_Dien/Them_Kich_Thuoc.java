 ...
 * @author GIGABYTE
 */
public class Them_Kich_Thuoc extends javax.swing.JFrame {

    private Repository.Repository_Size sz = new Repository_Size();
    private DefaultTableModel mol;

    /**
     * Creates new form Them_San_Pham
     */
    public Them_Kich_Thuoc() {
        initComponents();
    ...
    public void fill(ArrayList<Size_entity> list) {
        mol.setRowCount(0);
        for (Size_entity kd : list) {
            Object[] rowData
                    = {
                        kd.getId(),
                        kd.getSize()
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thêm kích thước");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Them_Kich_Thuoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Them_Kich_Thuoc().setVisible(true);
            }
        });
    }
